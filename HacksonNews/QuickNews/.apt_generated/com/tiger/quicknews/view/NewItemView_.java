    ...
    implements HasViews, OnViewChangedListener
{
    ...
    public void onViewChanged(HasViews hasViews) {
        itemcontent1 = ((TextView) hasViews.findViewById(id.item_content1));
        imageLayout = ((RelativeLayout) hasViews.findViewById(id.article_top_layout));
        itemTitle = ((TextView) hasViews.findViewById(id.item_title));
        leftImage = ((ImageView) hasViews.findViewById(id.left_image));
        btn_zhuanti = ((Button) hasViews.findViewById(id.btn_zhuanti));
        itemAbstract = ((TextView) hasViews.findViewById(id.item_abstract));
        articleLayout = ((LinearLayout) hasViews.findViewById(id.layout_image));
