...
import com.bfd.parse.reprocess.ahackthonImportInfoRe;
import com.bfd.parse.util.JsonUtil;

public class ahackthonImportnewInfoReTest {
	// 初始化taskdata数据结构，包含任务的各种配置
		...
		public static void main(String[] args) {
			...
			String url = "http://www.importnew.com/1099.html";
			...
			// 测试后处理插件
			ReProcessor reprocessor = new ahackthonImportInfoRe();
