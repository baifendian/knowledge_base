...
import com.bfd.parse.reprocess.ahackthonRunoobInfoRe;
import com.bfd.parse.util.JsonUtil;

public class ahackthonRunoobInfoReTest {
	// 初始化taskdata数据结构，包含任务的各种配置
		...
		public static void main(String[] args) {
			...
			String url = "http://www.runoob.com/w3cnote/internet-people-parade.html";
			
			DownloadClient crawler = new DownloadClient();
			String cid = "hackthon_runoob";
			...
			// 测试后处理插件
			ReProcessor reprocessor = new ahackthonRunoobInfoRe();
