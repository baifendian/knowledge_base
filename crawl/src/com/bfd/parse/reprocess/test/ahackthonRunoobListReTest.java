...
import com.bfd.parse.reprocess.ahackthonRunoobListRe;
import com.bfd.parse.util.JsonUtil;

public class ahackthonRunoobListReTest {
	// 初始化taskdata数据结构，包含任务的各种配置
		...
		public static void main(String[] args) {
			...
			String url = "http://www.runoob.com/w3cnote/w3cnote_genre/joke";
			...
			// 测试后处理插件
			ReProcessor reprocessor = new ahackthonRunoobListRe();
