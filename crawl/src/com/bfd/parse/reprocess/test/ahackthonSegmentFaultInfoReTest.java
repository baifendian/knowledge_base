...
import com.bfd.parse.reprocess.ahackthonSegmentFaultInfoRe;
import com.bfd.parse.util.JsonUtil;

public class ahackthonSegmentFaultInfoReTest {
	// 初始化taskdata数据结构，包含任务的各种配置
		...
		public static void main(String[] args) {
			...
			String url = "https://segmentfault.com/a/1190000005824084";
			url = "https://segmentfault.com/a/1190000005883995";
			...
			// 测试后处理插件
			ReProcessor reprocessor = new ahackthonSegmentFaultInfoRe();
