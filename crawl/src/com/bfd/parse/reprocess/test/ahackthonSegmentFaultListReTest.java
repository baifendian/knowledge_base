...
import com.bfd.parse.reprocess.ahackthonSegmentFaultListRe;
import com.bfd.parse.util.JsonUtil;

public class ahackthonSegmentFaultListReTest {
	// 初始化taskdata数据结构，包含任务的各种配置
		...
		public static void main(String[] args) {
			...
			String url = "https://segmentfault.com/t/ios/blogs";
			...
			// 测试后处理插件
			ReProcessor reprocessor = new ahackthonSegmentFaultListRe();
